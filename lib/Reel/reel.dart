...
Future<List<Map<String, dynamic>>> fetchStories() async {
  final QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('uploads').get();
  return snapshot.docs.map((doc) => doc.data() as Map<String, dynamic>).toList();
}

class ReelStoriesPageView extends StatefulWidget {
  const ReelStoriesPageView({super.key});

  @override
  State createState() => _StoriesPageViewState();
}

class _StoriesPageViewState extends State<ReelStoriesPageView> {
